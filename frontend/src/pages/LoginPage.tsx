  ...
  <div className="flex flex-col mt-auto">
    ...
    <div className="p-5 rounded-2xl bg-white/[0.04] border border-white/[0.08]">
      <p className="text-sm text-slate-300 italic leading-relaxed mb-4">
        "Building NeuroALS was a mission to give neurologists a tool that thinks ahead. By combining transformer deep learning with EMG signal analysis, we created a system that catches what the human eye cannot — early fasciculation patterns, subtle waveform anomalies, and risk signals that traditional methods miss entirely."
      </p>
      <div className="flex items-center gap-2.5">
        ...
        <div>
          <div className="text-xs font-semibold">Deepanshu Chauhan & Ujjwal</div>
          <div className="text-[10px] text-slate-500">NeuroALS Development Team</div>
        </div>
      </div>
    </div>
  </div>
